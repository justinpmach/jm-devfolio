...
const navVariants: Variants = {
  ...
  hidden: {
    opacity: 0,
    clipPath: 'polygon(0 50%, 100% 50%, 0 50%, 100% 50%)',
    height: '100%',
    transition: {
      type: 'spring',
      bounce: 0,
...
export default function TestNav() {
  ...
  return (
    <>
      <motion.nav
        className='border-2 border-slate-500 flex items-center w-full rounded-full shadow-sm'
        initial='initial'
      ...
      <button
        className='w-6 h-6 absolute top-5 right-4 z-40'
